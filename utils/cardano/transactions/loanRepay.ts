...
export function loanRepayTx(
  ...
  const createTx = useCallback(async () => {
    try {
      ...
      const newBorrowedValue = oracleInDatum.fields[4] - repayAmt
      ...
      const collateralOutValue = collateralInValue - BigInt(repayAmt / exchangeRate) + 2000000n //BigInt(repayAmt / exchangeRate * 1000) + 2000000n
