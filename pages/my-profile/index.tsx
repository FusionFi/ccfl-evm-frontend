...
const AccountContent = () => {
  ...
  if (auth && auth.email) {
    if (auth.kyc) {
      return <div className='my-profile-page-wrapper__account__content--has-account--verified'>
        <div className='my-profile-page-wrapper__account__content--has-account--verified__content'>
          ...
          <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body'>
            <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item'>
              ...
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__value'>username01</span>
            </div>
            <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item'>
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__title'>
                Email
              </span>
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__value'>mail@mail.com</span>
            </div>
            <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item'>
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__title'>
                Password
          ...
          <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body'>
            <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item'>
              ...
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__value'>James E. Hart</span>
            </div>
            <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item'>
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__title'>
                Date of birth
              </span>
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__value'>12/12/2001</span>
            </div>
            <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item'>
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__title'>
                SSN
            ...
            <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item'>
              ...
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__value'>303-956-4577</span>
            </div>
            <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item'>
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__title'>
                Address
              </span>
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__value'>1023 Roy Alley, Empire, Colorado, 80438</span>
            </div>
            <div className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item'>
              <span className='my-profile-page-wrapper__account__content--has-account--verified__content__body__item__title'>
                Email Address
    ...
    return <div className='my-profile-page-wrapper__account__content--has-account--no-verified'>
      <div className='my-profile-page-wrapper__account__content--has-account--no-verified__content'>
        ...
        <div className='my-profile-page-wrapper__account__content--has-account--no-verified__content__body'>
          <div className='my-profile-page-wrapper__account__content--has-account--no-verified__content__body__item'>
            ...
            <span className='my-profile-page-wrapper__account__content--has-account--no-verified__content__body__item__value'>username01</span>
          </div>
          <div className='my-profile-page-wrapper__account__content--has-account--no-verified__content__body__item'>
            <span className='my-profile-page-wrapper__account__content--has-account--no-verified__content__body__item__title'>
              Email
            </span>
            <span className='my-profile-page-wrapper__account__content--has-account--no-verified__content__body__item__value'>mail@mail.com</span>
          </div>
          <div className='my-profile-page-wrapper__account__content--has-account--no-verified__content__body__item'>
            <span className='my-profile-page-wrapper__account__content--has-account--no-verified__content__body__item__title'>
              Password
  ...
  return <div className='my-profile-page-wrapper__account__content--no-account'>
    <Button
      type="primary"
      className={twMerge('btn-primary-custom', 'my-profile-page-wrapper__account__content--no-account__signup')}
    >
      Signup for an account
    </Button>
    <div className='my-profile-page-wrapper__account__content--no-account__signin'>
      Already had an account?
      <Button onClick={handleUpdateAuth} type='link'>Signin</Button>
    </div>
  </div>
}
...
const KycStatus = () => {
  ...
  if (auth?.email) {
    if (auth.kyc) {
      return <div className='my-profile-page-wrapper__account__title__kyc'>
        ...
        <div className='my-profile-page-wrapper__borrowed'>
          <div className='my-profile-page-wrapper__borrowed__left'>
            <div className='my-profile-page-wrapper__borrowed__item'>
              <div className='my-profile-page-wrapper__borrowed__item__title'>
                Borrowed balance
              </div>
          ...
          <div className='my-profile-page-wrapper__borrowed__right'>
            ...
            <div className='my-profile-page-wrapper__borrowed__item'>
              ...
              <div className='my-profile-page-wrapper__borrowed__item__value'>
                <span className='my-profile-page-wrapper__borrowed__item__value__health--good'>1.66B</span>
                <InfoCircleOutlined size={12} style={{
                  color: "#1890FF"
                }} />
              </div>
            </div>
